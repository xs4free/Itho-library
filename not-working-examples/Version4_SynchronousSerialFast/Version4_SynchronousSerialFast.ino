/*
This is a working example, but the code isn't using the Itho-library properly.
See the 'examples' directory for correct examples on how to send a full button press.
*/
